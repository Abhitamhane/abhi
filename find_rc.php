...
<html lang="en">
    ...
    <body class="">
        <div class="main-wrapper">
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>RTO Management System <br>RC Search</h4>
         ...
         <form action="viewRc.php" method="post">
<div class="form-group">
   <label for="chassisno">Enter Chassis Number</label>
   <input type="text" class="form-control" id="chassisno" placeholder="Enter Chassis Number" autocomplete="off" name="chassisno" required>
                                    </div>
