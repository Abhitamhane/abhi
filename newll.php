...
$llno=mt_rand(1000000000,9999999999);
$name=$_POST['name'];
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">New LL Registration</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">New LL Registration</li>
                                    </ul>
                                </div>
...
<div class="col-sm-10">
<input type="Number" name="aadhar" value="" class="form-control" required='true'>
</div>
</div>
...
<div class="col-sm-10">
<input type="radio" name="status" value="0" required="required" checked="">Pending
<input type="radio" name="status" value="1" required="required">Approved
<input type="radio" name="status" value="2" required="required">Rejected
</div>
</div>
