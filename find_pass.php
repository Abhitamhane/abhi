                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>RTO Management System <br>E-Pass Search</h4>
...
<div class="form-group">
   <label for="aadhar">Enter your Mobile Number</label>
   <input type="text" class="form-control" id="ContactNumber" placeholder="Enter Your Mobile Number" autocomplete="off" name="ContactNumber" required>
                                    </div>
