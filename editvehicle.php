...
$sql="UPDATE vehicle SET status=:status where ID=:stid ";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">RC Status Update</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">RC Status Update</li>
                                    </ul>
                                </div>
...
$sql = "SELECT vehicle.chassisno, vehicle.vehiclenumber, vehicle.aadhar, vehicle.rto, vehicle.status, vehicle.color, vehicle.seatingtype, vehicle.fueltype, vehicle.engineno, vehicle.vechileclass, vehicle.regdate, vehicle.name from vehicle where vehicle.id=:stid";
...
<?php echo htmlentities($result->chassisno)?>
</div>
</div>
...
<div class="col-sm-10">
<?php echo htmlentities($result->engineno)?>
</div>
</div>
