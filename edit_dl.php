...
$sql="UPDATE dl SET status=:status where id=:stid ";
...
$msg=" DL Status updated successfully";
}
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">DL Status Update</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">DL Status Update</li>
                                    </ul>
                                </div>
...
$sql = "SELECT   dl.aadhar, dl.gender, dl.fatherName, dl.address, dl.llno, dl.rto, dl.name, dl.fatherName, dl.mobileNumber, dl.status, dl.dob from dl where dl.id=:stid" ;
...
<label for="default" class="col-sm-2 control-label">LL No: </label>
<div class="col-sm-10">
<?php echo htmlentities($result->llno)?>
</div>
</div>
