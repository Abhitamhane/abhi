    ...
    <div class="main-page">
       <div class="container-fluid">
             <div class="row page-title-div">
               <div class="col-md-12">   
  <h2 class="title" align="center">DL Registration Details</h2>
                                </div>
                            </div>
                            <!-- /.row -->
...
$qery = "SELECT   dl.dlno, dl.aadhar, dl.address, dl.llno, dl.rto, dl.name, dl.fatherName, dl.status, dl.dob from dl where dl.aadhar=:aadhar";
...
?>
        ...
        <tr>
                 <th colspan="2">
                        <center><p><b>DL No : <?php echo htmlentities($row->rto);?><?php echo htmlentities($row->dlno);?></b></p></center>
                 </th>
            </tr>
